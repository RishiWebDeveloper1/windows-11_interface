...
function createAllAppsBox() {
    ...
    if (allAppsBoxCheck == true) {
        let appNameList = [
            ['File Explorer', 'Vs code', 'Chrome', 'YouTube', 'File Explorer', 'Vs code', 'Chrome'],
            ['free fire', 'pubg', 'COC', 'brwal'],
            ['hack', 'live-server', 'icon-pack']
        ];
        ...
        let appIconList = [
            ['images/app_images/file_explorer_icon.png',
                ...
                'images/app_images/chrome_icon.png',
                'images/app_images/youtube_icon.png'],
            ['free-fire.png', 'pubg.png', 'https://COC.png', 'brwal.png'],
            ['https://hack.png', 'https://live-server.png', 'https://icon-pack.png']
        ];
        ...
        let appUrlList = [
            ...
            ['components/apps/free-fire.html', 'https\:pubg', 'components/apps/COC.html', 'components/apps/brwal.html'],
            ['components/apps/hack.html', 'https\:live-server', 'components/appsicon-pack.html']
        ];
