...
function snapLayoutManager(idName) {
    // console.log('maximize movse hover');
    if (document.querySelector('.snap-layout-box')) {
        let snapLayoutManager = document.querySelector('.snap-layout-box');
        snapLayoutManager.addEventListener('mouseenter', () => {
            console.log('snap layout box entery of mouse');
            return;
        })
    }
            ...
            boxData.forEach(boxName => {
                if (boxName == "box8" || boxName == "box9" || boxName == "box10" || boxName == "box11") {
                    ...
                    box.onclick = function () {
                        snapLayoutMiniManager(idName, box);
                    }
